...
QUESTION: {question}"""
    ...
    def search_enhanced(self, query: str, top_k: int = 5, category: Optional[str] = None,
        ...
        for r in results:
            ...
            result_dict["relevance_score"] = round(min(1.0, base_score + title_boost + category_boost), 4)
    ...
    def ask(self, question: str, top_k: int = 5, category: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            with LogTimer(logger, "ask"):
                ...
                try:
                    articles = self.search_enhanced(query=question, top_k=top_k, category=category)
